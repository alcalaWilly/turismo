...
class Naturales extends StatefulWidget {
  final Categorias categoria;

  Naturales({required this.categoria, Key? key}) : super(key: key);

  @override
  _NaturalesState createState() => _NaturalesState();
}

class _NaturalesState extends State<Naturales> {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////
            } else if (lugar.nombre == 'Cascada Inkani') {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => CascadaIncani(
                      lugar: lugar), // Cambia a la clase correcta para la cueva
                ),
              );
////////////////////////////////////////////////////////////////////////////////////////////////////////////
            } else if (lugar.nombre == 'Catarata Canuja') {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => Cataratacanuja(
                      lugar: lugar), // Cambia a la clase correcta para la cueva
                ),
              );
////////////////////////////////////////////////////////////////////////////////////////////////////////////
            } else if (lugar.nombre == 'Catarata Huahuari') {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => Cataratahuahuari(
                      lugar: lugar), // Cambia a la clase correcta para la cueva
                ),
              );
////////////////////////////////////////////////////////////////////////////////////////////////////////////
            } else if (lugar.nombre == 'Caverna Ashaninka') {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => Cavernaashaninka(
                      lugar: lugar), // Cambia a la clase correcta para la cueva
                ),
              );
////////////////////////////////////////////////////////////////////////////////////////////////////////////
            } else if (lugar.nombre == 'Caverna Nueva Italia') {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => Cavernanuevaitalia(
                      lugar: lugar), // Cambia a la clase correcta para la cueva
                ),
              );
////////////////////////////////////////////////////////////////////////////////////////////////////////////
            } else if (lugar.nombre == 'Cascada Nueva Italia') {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => Cascadanuevaitalia(
                      lugar: lugar), // Cambia a la clase correcta para la cueva
                ),
              );
////////////////////////////////////////////////////////////////////////////////////////////////////////////
            } else if (lugar.nombre == 'Catarata Ambitarini') {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => Catarataambitarini(
                      lugar: lugar), // Cambia a la clase correcta para la cueva
                ),
              );
////////////////////////////////////////////////////////////////////////////////////////////////////////////
            } else if (lugar.nombre == 'Catarata Cunampiaro') {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => Cataratacunampiaro(
                      lugar: lugar), // Cambia a la clase correcta para la cueva
                ),
              );
////////////////////////////////////////////////////////////////////////////////////////////////////////////
