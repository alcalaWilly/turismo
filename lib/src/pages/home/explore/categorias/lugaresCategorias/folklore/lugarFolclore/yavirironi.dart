...
class Yavirironi extends StatefulWidget {
  final Lugar lugar;

  Yavirironi({required this.lugar, Key? key}) : super(key: key);

  @override
  _YavirironiState createState() => _YavirironiState();
}

class _YavirironiState extends State<Yavirironi> {
