...
class Cataratahuahuari extends StatefulWidget {
  final Lugar lugar;

  Cataratahuahuari({required this.lugar, Key? key}) : super(key: key);

  @override
  _CataratahuahuariState createState() => _CataratahuahuariState();
}

class _CataratahuahuariState extends State<Cataratahuahuari> {
                  ...
                  child: InkWell(
                    onTap: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              Mapacataratahuahuari(lugar: widget.lugar),
                        ),
                      );
                    },
                    child: Row(
