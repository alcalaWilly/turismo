...
class Catarataambitarini extends StatefulWidget {
  final Lugar lugar;

  Catarataambitarini({required this.lugar, Key? key}) : super(key: key);

  @override
  _CatarataambitariniState createState() => _CatarataambitariniState();
}

class _CatarataambitariniState extends State<Catarataambitarini> {
                  ...
                  child: InkWell(
                    onTap: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              Mapacatarataambitarini(lugar: widget.lugar),
                        ),
                      );
                    },
                    child: Row(
