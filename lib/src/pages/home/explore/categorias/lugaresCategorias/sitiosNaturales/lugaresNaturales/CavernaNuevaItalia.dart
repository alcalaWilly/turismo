...
class Cavernanuevaitalia extends StatefulWidget {
  final Lugar lugar;

  Cavernanuevaitalia({required this.lugar, Key? key}) : super(key: key);

  @override
  _CavernanuevaitaliaState createState() => _CavernanuevaitaliaState();
}

class _CavernanuevaitaliaState extends State<Cavernanuevaitalia> {
                  ...
                  child: InkWell(
                    onTap: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              Mapacavernanuevaitalia(lugar: widget.lugar),
                        ),
                      );
                    },
                    child: Row(
