...
class Cataratacunampiaro extends StatefulWidget {
  final Lugar lugar;

  Cataratacunampiaro({required this.lugar, Key? key}) : super(key: key);

  @override
  _CataratacunampiaroState createState() => _CataratacunampiaroState();
}

class _CataratacunampiaroState extends State<Cataratacunampiaro> {
                  ...
                  child: InkWell(
                    onTap: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              Mapacataratacunampiaro(lugar: widget.lugar),
                        ),
                      );
                    },
                    child: Row(
