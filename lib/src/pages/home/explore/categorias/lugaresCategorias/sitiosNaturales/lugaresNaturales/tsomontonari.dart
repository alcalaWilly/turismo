...
class Tsomontonari extends StatefulWidget {
  final Lugar lugar;

  Tsomontonari({required this.lugar, Key? key}) : super(key: key);

  @override
  _TsomontonariState createState() => _TsomontonariState();
}

class _TsomontonariState extends State<Tsomontonari> {
                  ...
                  child: InkWell(
                    onTap: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              Mapatsomontonari(lugar: widget.lugar),
                        ),
                      );
                    },
                    child: Center(
                      child: InkWell(
                        onTap: () {
                          ...
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => Mapatsomontonari(
                                lugar: widget
