...
class Mapacavernaashaninka extends StatefulWidget {
  final Lugar lugar; // Recibe el lugar seleccionado

  const Mapacavernaashaninka({required this.lugar, Key? key}) : super(key: key);

  @override
  State<Mapacavernaashaninka> createState() => _MapacavernaashaninkaState();
}

class _MapacavernaashaninkaState extends State<Mapacavernaashaninka> {
