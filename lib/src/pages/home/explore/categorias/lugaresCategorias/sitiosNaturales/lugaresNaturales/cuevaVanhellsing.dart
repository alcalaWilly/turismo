...
class Cuevavanhellsing extends StatefulWidget {
  final Lugar lugar;

  Cuevavanhellsing({required this.lugar, Key? key}) : super(key: key);

  @override
  _CuevavanhellsingState createState() => _CuevavanhellsingState();
}
                  ...
                  child: InkWell(
                    onTap: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              Mapavanhellsing(lugar: widget.lugar),
                        ),
                      );
                    },
                    child: Row(
