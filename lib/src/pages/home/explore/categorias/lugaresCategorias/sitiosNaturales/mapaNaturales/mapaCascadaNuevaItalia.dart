...
class Mapacascadanuevaitalia extends StatefulWidget {
  final Lugar lugar; // Recibe el lugar seleccionado

  const Mapacascadanuevaitalia({required this.lugar, Key? key})
      : super(key: key);

  @override
  State<Mapacascadanuevaitalia> createState() => _MapacascadanuevaitaliaState();
}

class _MapacascadanuevaitaliaState extends State<Mapacascadanuevaitalia> {
