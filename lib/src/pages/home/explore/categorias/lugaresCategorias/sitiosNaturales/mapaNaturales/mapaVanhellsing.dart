...
class Mapavanhellsing extends StatefulWidget {
  final Lugar lugar; // Recibe el lugar seleccionado

  const Mapavanhellsing({required this.lugar, Key? key}) : super(key: key);

  @override
  State<Mapavanhellsing> createState() => _MapavanhellsingState();
}

class _MapavanhellsingState extends State<Mapavanhellsing> {
