...
class Mapacataratahuahuari extends StatefulWidget {
  final Lugar lugar; // Recibe el lugar seleccionado

  const Mapacataratahuahuari({required this.lugar, Key? key}) : super(key: key);

  @override
  State<Mapacataratahuahuari> createState() => _MapacataratahuahuariState();
}

class _MapacataratahuahuariState extends State<Mapacataratahuahuari> {
