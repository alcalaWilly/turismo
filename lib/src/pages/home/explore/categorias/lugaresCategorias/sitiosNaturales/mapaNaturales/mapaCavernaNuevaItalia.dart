...
class Mapacavernanuevaitalia extends StatefulWidget {
  final Lugar lugar; // Recibe el lugar seleccionado

  const Mapacavernanuevaitalia({required this.lugar, Key? key})
      : super(key: key);

  @override
  State<Mapacavernanuevaitalia> createState() => _MapacavernanuevaitaliaState();
}

class _MapacavernanuevaitaliaState extends State<Mapacavernanuevaitalia> {
