...
class Cavernaashaninka extends StatefulWidget {
  final Lugar lugar;

  Cavernaashaninka({required this.lugar, Key? key}) : super(key: key);

  @override
  _CavernaashaninkaState createState() => _CavernaashaninkaState();
}

class _CavernaashaninkaState extends State<Cavernaashaninka> {
                  ...
                  child: InkWell(
                    onTap: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              Mapacavernaashaninka(lugar: widget.lugar),
                        ),
                      );
                    },
                    child: Row(
