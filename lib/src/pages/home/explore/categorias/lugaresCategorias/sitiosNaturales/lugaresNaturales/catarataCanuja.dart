...
class Cataratacanuja extends StatefulWidget {
  final Lugar lugar;

  Cataratacanuja({required this.lugar, Key? key}) : super(key: key);

  @override
  _CataratacanujaState createState() => _CataratacanujaState();
}

class _CataratacanujaState extends State<Cataratacanuja> {
                  ...
                  child: InkWell(
                    onTap: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              Mapacataratacanuja(lugar: widget.lugar),
                        ),
                      );
                    },
                    child: Row(
