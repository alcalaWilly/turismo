...
class Mapacataratacunampiaro extends StatefulWidget {
  final Lugar lugar; // Recibe el lugar seleccionado

  const Mapacataratacunampiaro({required this.lugar, Key? key})
      : super(key: key);

  @override
  State<Mapacataratacunampiaro> createState() => _MapacataratacunampiaroState();
}

class _MapacataratacunampiaroState extends State<Mapacataratacunampiaro> {
