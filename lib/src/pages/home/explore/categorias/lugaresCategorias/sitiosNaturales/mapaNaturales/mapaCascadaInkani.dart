...
class Mapacascadainkani extends StatefulWidget {
  ...
  const Mapacascadainkani({required this.lugar, Key? key}) : super(key: key);

  @override
  State<Mapacascadainkani> createState() => _MapacascadainkaniState();
}

class _MapacascadainkaniState extends State<Mapacascadainkani> {
