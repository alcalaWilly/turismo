...
class Capilla extends StatefulWidget {
  final Lugar lugar;

  Capilla({required this.lugar, Key? key}) : super(key: key);

  @override
  _CapillaState createState() => _CapillaState();
}

class _CapillaState extends State<Capilla> {
